...
async def start(client, message):
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('❤️‍🔥 ᴊᴏɪɴ ᴛᴏ ᴄʜᴀɴɴᴇʟ ❤️‍🔥', url=str(MAIN_CHANNEL) if str(MAIN_CHANNEL).startswith("https://t.me/") else "https://t.me/+wBGHGw22IfVkZTRl")) ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
